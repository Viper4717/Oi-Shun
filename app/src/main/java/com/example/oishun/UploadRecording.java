/*
 * Recording Upload Activity Control
 *
 * @author A.M. Aahad
 * */
...
public class UploadRecording extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oldFileName = intent.getStringExtra("oldFileName");
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newFileName != null && newFileName.trim().length() > 0) {
                    ...
                    oldFile.renameTo(newFile);
                    oldFileName = null;
                    Toast.makeText(UploadRecording.this, "Saved", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                filePath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadRecording.this, "Upload Successful!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            }
